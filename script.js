$(document).ready(function() {
  ...
  function citySearch(e) {
    ...
    if ($('#cityInput').val() !== '') {
      ...
      const queryURL = `${BASE_URL}client_id=PGRFNMWYIQORRWIDI35ABOQZAFAB1AGPMHSLQ4DVNNA3FXQ5&client_secret=BFXFR3RHV1PI232XQ3A2FZ45L2K0LB22ZWWLHBLC5OJ3FX1P&v=20180323&limit=10&near=${city}&query=brewery`;
